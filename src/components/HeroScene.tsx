...
function SceneGroup() {
  ...
  useFrame((state) => {
    ...
    group.current!.scale.setScalar(0.9 + Math.sin(state.clock.elapsedTime * 1.2) * 0.1);
  });
...
export default function HeroScene() {
  return (
    <Canvas camera={{ position: [0, 0, 7], fov: 55 }} gl={{ antialias: true, alpha: true }} className="absolute inset-0">
