...
export default function Testimonials() {
  ...
  const filteredTestimonials = testimonials.filter((t) => {
    if (filter === "company")
      return t.company !== "Independent" && t.company !== "Career Change";
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(180deg, #000000 0%, #05030a 50%, #000000 100%)",
      }}
    >
      {/* Background Effects */}
        ...
        >
          <div>
            ...
            <h2 className="display-heading text-7xl md:text-8xl">
              2,400+
              <br />
              <span style={{ color: "var(--orange)" }}>Сэтгэгдэл</span>
            </h2>
          </div>
              ...
              {[
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    color:
                      filter === f.value ? "#fff" : "rgba(255,255,255,0.7)",
                  }}
                >
                  {f.label}
                </motion.button>
            ...
            <div className="flex gap-3">
              <motion.button
                ...
                onClick={() =>
                  setCurrent(
                    (p) =>
                      (p - 1 + filteredTestimonials.length) %
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() =>
                  setCurrent((p) => (p + 1) % filteredTestimonials.length)
                }
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="font-condensed font-700 text-white uppercase tracking-wide">
                      {t.name}
                    </div>
                    <div className="w-px h-4 bg-white/20" />
                    <div className="font-condensed text-white/40 text-sm">
                      {t.role}
                    </div>
                  </div>
                </div>
          ...
          {testimonials.map((_, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: "2px",
                background:
                  i === current ? "var(--orange)" : "rgba(255,255,255,0.15)",
          ...
          {testimonials.slice(0, 3).map((t, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="font-condensed font-700 text-white text-sm uppercase">
                    {t.name}
                  </div>
